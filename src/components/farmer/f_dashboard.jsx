  ...
  return (
    <div className="mt-4 px-3">
      ...
      <Card className="mb-4 shadow-sm border-0 d-flex flex-row align-items-center p-3">
        ...
        />
        <div>
          <h4 className="mb-1 text-success">Welcome, {stats.name}</h4>
          <p className="mb-0 text-muted">Here's your crop summary & updates</p>
        </div>
      </Card>

      {/* Dashboard Stats */}
      <h5 className="text-muted mb-3">📊 Farmer Dashboard Overview</h5>
      <Row className="g-4">
        <Col md={3}>
      ...
      {/* Crop Categories */}
      <hr className="my-4" />
      <h5 className="text-muted mb-3">Crop Categories</h5>
      <Row className="g-3">
